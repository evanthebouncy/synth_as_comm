...
function new_problem(target_id){
...
$(document).ready(function(){
    ...
    target_id = parseInt(urlParams.get('target_id'));
    robot_id =  parseInt(urlParams.get('robot_id'));
    console.log("user id, target id, robot id");
    console.log(user_id);
