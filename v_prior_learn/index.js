...
function make_candidates(){
    for (var cand=0; cand<2; cand++){
        ...
        box.innerHTML = cand == 0 ? "Lp robot " : "L1 robot";
...
function make_layout() {
    ...
    $(box).css("background-image", 'url(assets/robot_prior.png)');
    $("#control").append(box);
...
function run_l0() {
    let lp_candidates = L_prior(examples);
    render_l_results(lp_candidates, 0);
}
